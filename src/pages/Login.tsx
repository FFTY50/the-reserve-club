...
import logoImage from '@/assets/vino-sabor-logo.jpeg';
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-8">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-serif text-primary mb-2">The Reserve Club</h1>
              <p className="text-sm text-muted-foreground">Operations Portal Access</p>
            </div>
